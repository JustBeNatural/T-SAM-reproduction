...
from models.sd1_5.clip_compat import get_clip_final_layer_norm
    ...
    def encode_prompt(
        ...
        if prompt_embeds is None:
            ...
            if clip_skip is None:
                ...
                # layer.
                prompt_embeds = get_clip_final_layer_norm(self.text_encoder)(prompt_embeds)
            ...
            for i, t in enumerate(timesteps):
                ...
                with torch.enable_grad():
                    ...
                    for j, (latent, text_embedding) in enumerate(
                        ...
                        if max_iter_to_alter != 0 and i in latent_opt_config.iterative_refinement_steps:
